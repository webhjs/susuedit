<template>
  <el-form label-width="80px" :model="formInline" :rules="rules" ref="attributeForm" :inline="true">
    ...
    <el-form-item label="最小值" class="form-item">
      <el-input class="input-item" v-model="formInline.minValue" placeholder="请输入最小值"></el-input>
    </el-form-item>
    <el-form-item label="最大值" class="form-item">
      <el-input class="input-item" v-model="formInline.maxValue" placeholder="请输入最大值"></el-input>
    </el-form-item>
