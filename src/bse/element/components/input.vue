    ...
    <div class="layout-wrap">
      <div class="left">
        ...
        <el-form-item label="默认值" class="form-item">
          <el-input class="input-item" v-model="formInline.value" placeholder="请输入默认值"></el-input>
        </el-form-item>
        ...
        <el-form-item label="最小位数" class="form-item">
          <el-input class="input-item" v-model="formInline.minNumber" placeholder="请输入最小位数"></el-input>
        </el-form-item>
        <el-form-item label="最大位数" class="form-item">
          <el-input class="input-item" v-model="formInline.maxNumber" placeholder="请输入最大位数"></el-input>
        </el-form-item>
      </div>
