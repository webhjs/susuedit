    ...
    <div class="layout-wrap">
      <div class="left">
        ...
        <el-form-item label="行为属性" class="form-item">
          <el-checkbox
            ...
            :false-label="0"
            @change="
              (val) => (formInline.notallowdelete = val == 0 ? false : true)
            "
            label="不允许删除"
          ></el-checkbox>
        </el-form-item>
      ...
      <div class="right">
        ...
        <el-form-item class="form-item">
          ...
          <el-input
            class="input-item"
            v-model="formInline.settleExpression"
            placeholder="结算表达式"
          ></el-input>
        </el-form-item>
      </div>
